...
For first plot, the total number of checkouts will be visualized for each year with different lines for material type.
...
For second plot, the total number of checkouts for some of the publisher will be visualized for each year.
...
For this plot, I will use bar plot to visualize the distribution of number of checkouts for each year. The reason for this plot is to identify for which year the number of checkouts are highest and for which year the number of checkouts are lowest.
```{r}
#distribution of checkout by year
